...
saveRDS(BBS_results,"1_output/BBS/BBS_results.rds")
...
#                                      regions = c("national"))
# 
# national_trend_1998_2018 <- generate_trends(indices = national_indices,Min_year = 1998,Max_year = 2018)  %>%  subset(Region == "CA")
...
# indices_1998 <- national_indices$samples$national_CA[,which(years == 1998)]
...
# 
# pchange_1998_2018 <- (indices_2018 - indices_1998)/indices_1998 * 100
# mean(pchange_1998_2018  <= -30)
# 
# pchange_2008_2018 <- (indices_2018 - indices_2008)/indices_2008 * 100
# mean(pchange_2008_2018  <= -30)
# 
# trend_table <- rbind(national_trend_1998_2018,
#                      national_trend_2008_2018)[,-6]
# 
# trend_table$prob_increase <- c(mean(pchange_1998_2018  > 0),mean(pchange_2008_2018  > 0))
# trend_table$prob_30_decline <- c(mean(pchange_1998_2018  <= -30),mean(pchange_2008_2018  <= -30))
# trend_table$prob_50_decline <- c(mean(pchange_1998_2018  <= -50),mean(pchange_2008_2018  <= -50))
# 
